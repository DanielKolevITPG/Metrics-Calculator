"""
Matrix Calculator CLI - A menu-driven interface for matrix operations.

This program provides an interactive command-line interface for performing
various matrix operations including addition, subtraction, multiplication,
determinant, inverse, transpose, and scalar operations.
"""
...
def input_matrix(prompt: str) -> Matrix:
    ...
    Can also use commas: "1,2,3;4,5,6"
    ...
    while True:
        ...
        try:
            ...
            if choice == "1":
                ...
                A = input_matrix("Enter first matrix (A)")
                B = input_matrix("Enter second matrix (B)")
                if confirm_operation(f"Computing A * B (matrix multiplication):\n{A}\n*\n{B}"):
                    result = A * B
                    print("\nResult (A * B):")
                    print(result)
